...
export default function ResumeUpload() {
  ...
  const handleContinue = () => {
    console.log("Extracted Text:", rawText); // 👈 Just log the extracted data
    console.log("File Name:", fileName);

    router.push("/dashboard/upload/edit-upload"); // 👈 Navigate to next page (change path as needed)
  };
    ...
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark font-display">
      <main className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-lg space-y-8">
          <div className="bg-white dark:bg-background-dark/50 shadow-lg rounded-xl p-8 space-y-6">
                ...
                <div className="flex flex-col items-center justify-center space-y-4">
                  ...
                  {fileName && (
                    <button
                      ...
                      className="mt-2 bg-blue-200 font-bold py-2 px-4 text-blue-600 rounded hover:bg-blue-200 transition-colors"
                      disabled={loading}
                    >
